...
function Badge({ label, tone }: { label: string; tone: BadgeTone }) {
  const styles: Record<BadgeTone, string> = {
    ...
    rose:
      "border-rose-400/70 text-rose-600 dark:border-rose-400/50 dark:text-rose-200",
    amber:
      "border-amber-400/70 text-amber-700 dark:border-amber-400/50 dark:text-amber-200",
    sky:
      "border-sky-400/70 text-sky-700 dark:border-sky-400/50 dark:text-sky-200",
  };
  return (
    <span
      className={clsx(
